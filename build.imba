...
def runBuild
	...
	try
		await exec('imba build --baseurl "." app/server/index.imba')
	...
	const jsBasePath = "./dist/public/__assets__/app/client/"
	...
	const existingScriptTagSrc = path.join("./__assets__/app/client/", jsFileName)
